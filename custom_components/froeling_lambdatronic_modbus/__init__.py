        ...
        DOMAIN: vol.Schema(
            {
                ...
                vol.Optional("hk05", default=True): cv.boolean,
                vol.Optional("hk06", default=True): cv.boolean,
                vol.Optional("hk07", default=True): cv.boolean,
                vol.Optional("hk08", default=True): cv.boolean,
                vol.Optional("hk09", default=True): cv.boolean,
