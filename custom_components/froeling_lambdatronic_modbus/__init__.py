        ...
        DOMAIN: vol.Schema(
            {
                ...
                vol.Optional("diff-regler", default=True): cv.boolean,
                vol.Optional("hk1", default=True): cv.boolean,
                vol.Optional("hk2", default=True): cv.boolean,
                vol.Optional("hk3", default=True): cv.boolean,
                vol.Optional("hk4", default=True): cv.boolean,
                vol.Optional("hk5", default=True): cv.boolean,
                vol.Optional("hk6", default=True): cv.boolean,
                vol.Optional("hk7", default=True): cv.boolean,
                vol.Optional("hk8", default=True): cv.boolean,
                vol.Optional("hk9", default=True): cv.boolean,
                vol.Optional("hk10", default=True): cv.boolean,
                vol.Optional("hk11", default=True): cv.boolean,
                vol.Optional("hk12", default=True): cv.boolean,
                vol.Optional("hk13", default=True): cv.boolean,
                vol.Optional("hk14", default=True): cv.boolean,
                vol.Optional("hk15", default=True): cv.boolean,
                vol.Optional("hk16", default=True): cv.boolean,
                vol.Optional("hk17", default=True): cv.boolean,
                vol.Optional("hk18", default=True): cv.boolean,
